...
import {judulmenutotal} from './component/header/arraymenu';
        ...
        {menulinkkom.map((item,index)=> {
          return(
            <Route exact path={item}>
              ...
              {index % 2 === 0 ?
               <ProfilResponden judulmenu={judulmenutotal[Math.floor(index/4)]} datatotalgrafik={profiltot[index/2]} jsontotal={datares[(index)/2]}/>
                :
